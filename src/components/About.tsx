  ...
  const values = [
    {
      ...
      description:
        "We believe in showing Christ's love through our actions and service to others.",
    },
    {
      icon: Users,
      title: "Community",
      description:
        "Building meaningful relationships and supporting each other in faith and life.",
    },
    {
      icon: BookOpen,
      title: "Biblical Truth",
      description:
        "Grounding our faith and teachings in the unchanging Word of God.",
    },
    {
      icon: HandHeart,
      title: "Prayer & Worship",
      description:
        "Creating sacred moments to connect with God through prayer and praise.",
    },
  ];
    ...
    <section id="about" className="py-20 bg-gradient-warm">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="font-heading text-4xl md:text-5xl font-bold mb-6 text-red-600">
            About Our Church
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Kenya Assemblies of God South C is a vibrant community of believers
            committed to worship, fellowship, and spiritual growth. We welcome
            all people to join us in experiencing God's love and grace.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          <div>
            {/* Black Headings */}
            <h3 className="font-heading text-3xl font-semibold mb-6 text-foreground">
              Our Mission
            </h3>
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              We are a family living and working together in prayer, witnessing,
              study of God's Word and making disciples to impact our community
              in following Christ.
            </p>
