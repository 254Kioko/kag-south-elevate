...
const handleSubscribe = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (error) {
      ...
      toast({
        title: "Subscribed!",
        description: "You’ll now receive event updates.",
      });
      setEmail("");
  ...
  <div className="container mx-auto px-4">
    <div className="text-center bg-gradient-primary rounded-2xl p-12 text-primary-foreground shadow-elegant max-w-4xl mx-auto">
      ...
      <p className="mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
        Stay up to date with upcoming services, special programs, and church events.
      </p>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              size="lg"
              className="font-semibold bg-primary-foreground/10 border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/20"
            >
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Enter your email to receive reminders and announcements.
              </DialogDescription>
            </DialogHeader>
