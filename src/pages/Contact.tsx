        ...
        <section className="bg-gradient-subtle py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We'd love to hear from you. Send us a message or prayer request
              (anonymously if you prefer) and we'll respond as soon as possible.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card className="shadow-elegant">
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form below and we'll get back to you. You can
                    submit prayer requests anonymously.
                  </CardDescription>
                </CardHeader>
